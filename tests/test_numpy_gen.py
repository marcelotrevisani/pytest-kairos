...
@pytest.mark.config_kairos("np_array", dtype=np.int64, size=(3, 3), min=0, max=5, repeat=100)
...
@pytest.mark.config_kairos("np_float", dtype=np.float32, size=(2, 2), min=0, max=10, repeat=100)
